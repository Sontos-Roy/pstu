...
<div class="container-fluid">
    <div class="block-header">
        <h2>Add Academic Calendar</h2>
        <small class="text-muted">Patuakhali Science & Technology University</small>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <form action="{{ route('admin.academic_calendars.store') }}" method="POST" id="ajax_form">
                    @csrf
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="date" name="class_completion" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="date" name="first_mid_term" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="date" name="second_mid_term" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="date" name="field_work" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
