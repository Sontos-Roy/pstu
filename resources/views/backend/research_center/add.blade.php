...
<div class="container-fluid">
    <div class="block-header">
        <h2>Add Research Center</h2>
        <small class="text-muted">Patuakhali Science & Technology University</small>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <form action="{{ route('admin.research_center.store') }}" method="POST" id="ajax_form">
                    @csrf
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <label for="">Center Derector</label>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="website" class="form-control" placeholder="Research Website ">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="4" id="editor" name="brief" class="form-control no-resize" placeholder="Details"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
