...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <form action="{{ route('admin.faculties.store') }}" method="POST" id="ajax_form">
                    @csrf
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="4" id="editor" name="introduction" class="form-control no-resize" placeholder="Introduction"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
