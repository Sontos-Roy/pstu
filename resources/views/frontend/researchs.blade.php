                    ...
                    <div class="panel panel-primary ">
                        <div class="panel-heading" id="heading-gradiant">
                            ...
                            <div class="col-sm-2 text-right">
                                <a href="{{ route('front.researchs') }}" class="btn btn-info btn-xs"> Refresh</a>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="item">
                                                    <div class="info" style="width: 100%;padding-top: 20px">
                                                        <h5 style="text-align: justify"> <a href="{{ route('front.researchs.show', $research->slug) }}" target="_blank">{{ $research->title }}</a>
                                                        </h5>
                                                        <ul>
                                                            <li class="border" style="display: inline-block;">
                                                                <span>
                                                                Published Date: {{ date('d M Y', strtotime($research->created_at)) }}</span>
                                                            </li>
                                                            <li style="display: inline-block;" class="pull-right">
                                                                <a href="{{ route('front.researchs.show', $research->slug) }}" target="_blank" class="btn circle btn-dark border btn-sm text-center">
