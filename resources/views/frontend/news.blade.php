                                            ...
                                            <div class="row">
                                                ...
                                                <div class="item">
                                                    <div class="info" style="width: 100%;padding-top: 20px">
                                                        <h5 style="text-align: justify"> <a href="{{ route('front.news.show', $notice->slug) }}" target="_blank">{{ $notice->heading }}</a>
                                                        </h5>
                                                        <ul>
                                                            ...
                                                            <li style="display: inline-block;" class="pull-right">
                                                                <a href="{{ route('front.news.show', $notice->slug) }}" target="_blank" class="btn circle btn-dark border btn-sm text-center">
