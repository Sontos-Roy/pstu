    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <h2>Directors of Institute</h2>
                <ul class="breadcrumb">
                    <li><a href="{{ route('front.home') }}"><i class="fas fa-home"></i> Home</a></li>
                    <li class="active">Directors of Institute</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="advisor-items col-3 text-light text-center">
                ...
                <div class="col-md-4 col-sm-6 single-item">
                    <a href="{{ route('front.institutes.intro', $item->slug) }}">
                    </a>
                    <div class="item">
                        <a href="{{ route('front.institutes.intro', $item->slug) }}">
                            <div class="thumb">
                        ...
                        <div class="info" style="height: 140px">
                            <a href="{{ route('front.institutes.intro', $item->slug) }}">
                            </a><a href="{{ route('front.institutes.intro', $item->slug) }}">
                            <span>{{ $item->name }}</span>
                            </a>
                            <h4>
                                <a href="{{ route('front.institutes.intro', $item->slug) }}" target="_blank"> {{ $item->user->name }}
                                </a>
                            </h4>
                            <span>
                            </span>
                        ...
                        <div class="text-center">
                            <a class="btn circle btn-dark border btn-sm" href="{{ route('front.institutes.intro', $item->slug) }}" style="margin:10px;">Read More...<i class="fas fa-check-circle fa-2x fa-pull-right"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach
