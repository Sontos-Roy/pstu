...
@endpush
@section('content')
<div class="breadcrumb-area shadow dark text-center text-light" style="background-image: url('{{ $faculty->banner ? getImage('faculties', $faculty->banner) : getImage('settings', getSetting('pagebanner1')) }}'); background-size: cover; background-repeat: no-repeat;padding: 103px 0;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{ $faculty->title }}</li>
                </ul>
            </div>
        </div>
    </div>
