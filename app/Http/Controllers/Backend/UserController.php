...
class UserController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.users.edit',compact('user','roles','userRole', 'departments', 'faculties','designations'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json(['status'=>true, 'msg'=>'User Deleted Successfuly', 'url'=>route('admin.users.index')]);
    }
